...
\begin{DoxyCompactList}\small\item\em class \hyperlink{classCreditsCommand}{Credits\-Command} used to print the credits of the game \end{DoxyCompactList}\end{DoxyCompactItemize}
