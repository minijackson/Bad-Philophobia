...
References \hyperlink{Room_8java_source_l00016}{description}.
...
References \hyperlink{Room_8java_source_l00032}{contained\-Items}, \hyperlink{Room_8java_source_l00016}{description}, \hyperlink{Room_8java_source_l00022}{exits}, and \hyperlink{Room_8java_source_l00027}{image\-Name}.
...
00052         \hyperlink{classRoom_a3ddf7c120b54509c43d803d2409158fc}{imageName} = image;
00053         \hyperlink{classRoom_a02eea1285ab8d50a2e25cc98d50b185d}{containedItems} = itemList;
00054     \}
\end{DoxyCode}
...
References \hyperlink{Room_8java_source_l00032}{contained\-Items}.


\begin{DoxyCode}
00069                                         \{
00070         \textcolor{keywordflow}{return} \hyperlink{classRoom_a02eea1285ab8d50a2e25cc98d50b185d}{containedItems};
00071     \}
\end{DoxyCode}
...
00170     \}
\end{DoxyCode}
\hypertarget{classRoom_a2ccc382c07890a9827be232767eb98a0}{\index{Room@{Room}!get\-Exit\-String@{get\-Exit\-String}}
\index{get\-Exit\-String@{get\-Exit\-String}!Room@{Room}}
\subsubsection[{get\-Exit\-String}]{\setlength{\rightskip}{0pt plus 5cm}String Room.\-get\-Exit\-String (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classRoom_a2ccc382c07890a9827be232767eb98a0}
...
Definition at line \hyperlink{Room_8java_source_l00156}{156} of file \hyperlink{Room_8java_source}{Room.\-java}.



References \hyperlink{Room_8java_source_l00022}{exits}.
...
\begin{center}
\leavevmode
\includegraphics[width=348pt]{classRoom_a2ccc382c07890a9827be232767eb98a0_icgraph}
\end{center}
\end{figure}
...
References \hyperlink{Room_8java_source_l00027}{image\-Name}.
...
Return an \hyperlink{classItem}{Item} through it's name. 
...
References \hyperlink{Room_8java_source_l00016}{description}, \hyperlink{Room_8java_source_l00156}{get\-Exit\-String()}, and \hyperlink{Room_8java_source_l00128}{get\-Human\-Items\-List()}.
...
\begin{DoxyCode}
00109                                         \{
00110         \textcolor{keywordflow}{return} \hyperlink{classRoom_a2d7ecf802690a6b13750ca6fa6882d77}{description};
00111     \}
\end{DoxyCode}
...
Check if the room has the given \hyperlink{classItem}{Item} through it's name. 
...
\hypertarget{classRoom_a02eea1285ab8d50a2e25cc98d50b185d}{\index{Room@{Room}!contained\-Items@{contained\-Items}}
\index{contained\-Items@{contained\-Items}!Room@{Room}}
\subsubsection[{contained\-Items}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Item\-List} Room.\-contained\-Items\hspace{0.3cm}{\ttfamily [private]}}}\label{classRoom_a02eea1285ab8d50a2e25cc98d50b185d}
...
\hypertarget{classRoom_a2d7ecf802690a6b13750ca6fa6882d77}{\index{Room@{Room}!description@{description}}
...
\hypertarget{classRoom_a29620da10d44de49ee8557e037f014af}{\index{Room@{Room}!exits@{exits}}
\index{exits@{exits}!Room@{Room}}
...
\hypertarget{classRoom_a3ddf7c120b54509c43d803d2409158fc}{\index{Room@{Room}!image\-Name@{image\-Name}}
\index{image\-Name@{image\-Name}!Room@{Room}}
