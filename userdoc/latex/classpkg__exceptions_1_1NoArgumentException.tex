...
class \hyperlink{classpkg__exceptions_1_1NoArgumentException}{No\-Argument\-Exception} used to tell that a given command must have a parameter. \begin{DoxyAuthor}{Author}
Rémi Nicole 
\end{DoxyAuthor}
