...
class \hyperlink{classPlayer}{Player} used to handle the user's player. \begin{DoxyAuthor}{Author}
Rémi Nicole 
\end{DoxyAuthor}
...
Check if the player can carry the given \hyperlink{classItem}{Item}. This methods simply checks the \hyperlink{classItem}{Item} with it's weight 
\begin{DoxyParams}{Parameters}
...
\begin{DoxyCode}
00089                                  \{
00090         \textcolor{keywordflow}{return} currentRoom;
00091     \}
\end{DoxyCode}
...
Return the last \hyperlink{classRoom}{Room}. \begin{DoxyReturn}{Returns}
...
\begin{DoxyCode}
00105                                   \{
00106         \textcolor{keywordflow}{return} (previousRooms.empty())? null : previousRooms.peek();
00107     \}
\end{DoxyCode}
...
\begin{DoxyCode}
00120                               \{
00121         previousRooms.push(currentRoom);
00122     \}
\end{DoxyCode}
...
\begin{DoxyCode}
00081                                             \{
00082         this.maxWeight = maxWeight;
00083     \}
\end{DoxyCode}
