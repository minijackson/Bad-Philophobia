...
Return an Character through it's name. \begin{DoxyReturn}{Returns}
...
Return a human readable list of the characters in the room. \begin{DoxyReturn}{Returns}
...
Return an Item through it's name. \begin{DoxyReturn}{Returns}
The wanted Item 
\end{DoxyReturn}
...
Return a random adjacent \hyperlink{classpkg__world_1_1Room}{Room} \begin{DoxyReturn}{Returns}
The wanted \hyperlink{classpkg__world_1_1Room}{Room} 
\end{DoxyReturn}
...
References \hyperlink{GameEngine_8java_source_l00289}{pkg\-\_\-game.\-Game\-Engine.\-get\-Rooms()}.
...
Check if the room has the given Character through it's name. \begin{DoxyReturn}{Returns}
...
Check if the room has the given Item through it's name. \begin{DoxyReturn}{Returns}
