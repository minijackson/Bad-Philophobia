...
00271     \}
00272 
00276     \textcolor{keyword}{private} \textcolor{keywordtype}{void} endGame() \{
00277         gui.println(\textcolor{stringliteral}{"Thank you for playing.  Good bye."});
00278         gui.enable(\textcolor{keyword}{false});
00279     \}
00280 
00281     \textcolor{keyword}{private} \textcolor{keywordtype}{void} test(\textcolor{keyword}{final} Command command) \{
