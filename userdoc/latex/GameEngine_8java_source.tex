...
00032 \{
00036     \textcolor{keyword}{private} \hyperlink{classpkg__world_1_1Player}{Player} player;
00037 
00041     \textcolor{keyword}{private} \textcolor{keyword}{static} ArrayList<Room> gameRooms;
00042 
00046     \textcolor{keyword}{private} HashSet<MovingCharacter> movingCharacters;
00047 
00051     \textcolor{keyword}{private} \hyperlink{classpkg__game_1_1UserInterface}{UserInterface} gui;
00052 
00059     \textcolor{keyword}{private} \textcolor{keywordtype}{int} helpCount;
00060 
00065     \textcolor{keyword}{private} \textcolor{keywordtype}{int} commandCountDown;
00066 
...
00073         player = \textcolor{keyword}{new} \hyperlink{classpkg__world_1_1Player}{Player}((javax.swing.JOptionPane.showInputDialog(\textcolor{stringliteral}{"What is your name"}).toLowerCase
...
00087     \}
00088 
00092     \textcolor{keyword}{private} \textcolor{keywordtype}{void} printWelcome() \{
...
00103     \}
00104 
00109     \textcolor{keyword}{private} Room createRooms() \{
...
00242             \textcolor{keywordflow}{for}(\hyperlink{classpkg__world_1_1pkg__characters_1_1MovingCharacter}{MovingCharacter} character : movingCharacters) \{
...
00277     \}
00278 
00283     \textcolor{keyword}{private} \textcolor{keywordtype}{void} endGame(\textcolor{keywordtype}{boolean} winning) \{
